 ...
 * 
 */
@WebServiceClient(name = "CalculatorWSService", targetNamespace = "http://servicios/", wsdlLocation = "http://localhost:18278/CalculatorApp/CalculatorWSService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWSSERVICE_QNAME = new QName("http://servicios/", "CalculatorWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:18278/CalculatorApp/CalculatorWSService?wsdl");
    ...
    public CalculatorWS getCalculatorWSPort() {
        return super.getPort(new QName("http://servicios/", "CalculatorWSPort"), CalculatorWS.class);
    }
    ...
    public CalculatorWS getCalculatorWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicios/", "CalculatorWSPort"), CalculatorWS.class, features);
    }
