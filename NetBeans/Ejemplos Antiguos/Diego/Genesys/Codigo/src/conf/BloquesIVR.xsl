        ...
        <fo:page-sequence initial-page-number='1' master-reference='A4-landscape'>
            ...
            <fo:static-content flow-name='footer'>
                <fo:block line-height='8pt' font-size='7pt' text-align='end' font-style='italic'>
                    Página <fo:page-number/> de <fo:page-number-citation ref-id='end-seq1'/>
		</fo:block>        		
            </fo:static-content>
        	...
        	<fo:table-column column-width='1cm'/>
                ...
                <fo:table-header background-color='#e6e6e6'>
                    <fo:table-row border-start-style='solid' border-end-style='solid' border-before-style='solid' border-width='0.3pt'>
                        ...
                        <fo:table-cell border-style='solid' border-width='1pt' number-rows-spanned='3' number-columns-spanned='2' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black' vertical-align='middle'>
                                Total Recibidas
                            </fo:block>
        		</fo:table-cell>
        		<fo:table-cell border-style='solid' border-width='1pt' number-columns-spanned='12' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                Tratamiento automático
                            </fo:block>
        		</fo:table-cell>
                        <fo:table-cell border-style='solid' border-width='1pt' number-rows-spanned='3' number-columns-spanned='3' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                Tratamiento agente
                            </fo:block>
        		</fo:table-cell>
        		...
        		<fo:table-cell border-style='solid' border-width='1pt' number-columns-spanned='3' number-rows-spanned='2' display-align="center">
