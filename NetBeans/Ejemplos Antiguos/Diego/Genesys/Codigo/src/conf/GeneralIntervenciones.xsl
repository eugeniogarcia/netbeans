...
<!--
    Document   : GeneralIntervenciones.xsl
    Created on : 7 de marzo de 2007, 12:36
    Author     : t610908
    Description:
        	...
        	<fo:table-column column-width="1.5cm"/> 
        		...
        		<fo:table-cell border-style='solid' border-width='1pt' number-rows-spanned='3' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                 Nº TOTAL INTERVENCIONES RECIBIDAS
                             </fo:block>
                        </fo:table-cell>
                        ...
                        <fo:table-cell border-style='solid' border-width='1pt' number-rows-spanned='3' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                 Tiempo Efectivo Conexion
                             </fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-style='solid' border-width='1pt' number-rows-spanned='3' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                 Intervenciones Atendidas por hora
                             </fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-style='solid' border-width='1pt' number-rows-spanned='3' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                        ...
                        <fo:table-cell border-style='solid' border-width='1pt' number-rows-spanned='2' number-columns-spanned='2' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                Interv. Atendidas &lt; &#61; 20s
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-style='solid' border-width='1pt' number-rows-spanned='3' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
        		...
        		<fo:table-cell border-style='solid' padding='1pt' border-width='1pt' number-columns-spanned='3' display-align="center">
                        ...
                        <fo:table-cell border-style='solid' padding='1pt' border-width='1pt' number-columns-spanned='3' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='6pt' color='black'>
                                Resueltas con intento de transferencia
                            </fo:block>
                        </fo:table-cell>  
                        <fo:table-cell border-style='solid' padding='1pt' border-width='1pt' number-columns-spanned='3' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='6pt' color='black'>
                        ...
                        <fo:table-cell border-style='solid' padding='1pt' border-width='1pt' number-rows-spanned='2' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='6pt' color='black'>
                                Intentos de transferencia sin éxito
                            </fo:block>
                        </fo:table-cell> 
