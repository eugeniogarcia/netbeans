   	...
   	<fo:simple-page-master master-name='A4-landscape' margin-right='0.5cm' margin-left='0.5cm' margin-bottom='1cm' margin-top='1cm' page-height="21cm" page-width="29.7cm">
        ...
        <fo:page-sequence initial-page-number='1' master-reference='A4-landscape'>
        	...
        	<fo:table-column column-width='1.8cm'/>
        		...
        		<fo:table-cell border-style='solid' border-width='1pt' number-rows-spanned='4' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                 Nº TOTAL LLAMADAS RECIBIDAS
                             </fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-style='solid' border-width='1pt' number-columns-spanned='6' number-rows-spanned='2' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                 TRATAMIENTO AUTOMÁTICO
                            </fo:block>
                        </fo:table-cell> 
                        <fo:table-cell border-style='solid' border-width='1pt' number-columns-spanned='20' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                 TRATAMIENTO AGENTE
                             </fo:block>
                        </fo:table-cell>               
        		...
        		<fo:table-cell border-style='solid' border-width='1pt' number-columns-spanned='2' display-align="center">
                        ...
                        <fo:table-cell border-style='solid' border-width='1pt' number-rows-spanned='2' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' font-size='7pt' color='black' padding-top='5pt'>
                                Nº
                            </fo:block>												   
        		</fo:table-cell>
        		<fo:table-cell border-style='solid' border-width='1pt' number-rows-spanned='2' display-align="center">
