    ...
    <xsl:template match="datosTabla">    
 	...
 	<fo:layout-master-set>
   	<fo:simple-page-master master-name='A4-landscape' margin-right='0.5cm' margin-left='0.5cm' margin-bottom='1cm' margin-top='1cm' page-height="21cm" page-width="29.7cm">
        ...
        <fo:page-sequence initial-page-number='1' master-reference='A4-landscape'>
        	...
        	<fo:table-column column-width='0.75cm'/>
        		...
        		<fo:table-cell border-style='solid' border-width='1pt' number-columns-spanned='5' display-align="center">
                            <fo:block line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black' text-align='center' vertical-align='middle'>
                                Recibidas
                            </fo:block>
        		</fo:table-cell>
        		...
        		<fo:table-cell border-style='solid' border-width='1pt' number-columns-spanned='5' display-align="center">
                    ...
                    <fo:table-row border-start-style='solid' border-end-style='solid' border-before-style='solid' border-width='0.3pt'>
                        <fo:table-cell border-style='solid' padding='1pt' border-width='1pt' number-rows-spanned='2' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' text-decoration='underline' font-size='7pt' font-weight='bold' color='black'>
        		...
        		<fo:table-cell border-style='solid' padding='1pt' border-width='1pt' number-columns-spanned='2' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='6pt' color='black'>
				Directas
                            </fo:block>
        		</fo:table-cell> 
				...
				Internas
                        ...
                        <fo:table-cell border-style='solid' padding='1pt' border-width='1pt' number-columns-spanned='4' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='6pt' color='black'>
				Total
                            </fo:block>
        		</fo:table-cell>
				...
				Total
                        ...
                        <fo:table-cell border-style='solid' padding='1pt' border-width='1pt' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='6pt' color='black'>
				En cola
                            </fo:block>
        		</fo:table-cell>
				...
				Nº
                         ...
                         <fo:table-cell border-style='solid' padding='1pt' border-width='1pt' number-columns-spanned='3' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='6pt' color='black'>
				Total
                            </fo:block>
        		</fo:table-cell>
      ...
      <xsl:template match="columna">
          <fo:table-cell padding-left='1mm' border-left-width='0.3pt' border-left-style='solid' display-align="center">
               <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='6pt' color='black'>
