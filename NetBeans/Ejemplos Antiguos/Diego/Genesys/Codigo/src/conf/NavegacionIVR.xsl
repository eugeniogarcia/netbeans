 	...
 	<fo:layout-master-set>
   	<fo:simple-page-master master-name='A4-landscape' margin-right='0.5cm' margin-left='0.5cm' margin-bottom='1cm' margin-top='1cm' page-height="21cm" page-width="29.7cm">
        ...
        <fo:page-sequence initial-page-number='1' master-reference='A4-landscape'>
        	...
        	<fo:table-column column-width='2.0cm'/> 
        		...
        		<fo:table-cell border-style='solid' number-rows-spanned='4' border-width='1pt' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                Total Recibidas
                            </fo:block> 
			</fo:table-cell>
			<fo:table-cell border-style='solid' number-columns-spanned='8' border-width='1pt' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                Tratamiento automatico
                            </fo:block> 
			</fo:table-cell>	
			<fo:table-cell border-style='solid' number-columns-spanned='2' border-width='1pt' number-rows-spanned='3' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                 Tratamiento agente
                            </fo:block> 
			</fo:table-cell>				                  
        		...
        		<fo:table-cell border-style='solid' border-width='0.3pt' number-columns-spanned='2' number-rows-spanned='2' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif'  vertical-align='middle' font-size='6pt' color='black'>
                                Total												 
                            </fo:block>
        		</fo:table-cell> 
        		<fo:table-cell border-style='solid' border-width='0.3pt' number-columns-spanned='4' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif'  vertical-align='middle' font-size='6pt' color='black'>
                                Resueltas												 
                            </fo:block>
        		</fo:table-cell> 
        		...
        		<fo:table-cell border-style='solid' border-width='0.3pt' number-columns-spanned='2' display-align="center">
                    ...
                    <fo:table-row border-start-style='solid' border-end-style='solid' border-before-style='solid' border-width='1pt'>
                         <fo:table-cell border-right-style='solid' border-right-width='0.3pt' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' font-size='7pt' color='black'>Nº</fo:block>
                        </fo:table-cell> 
        		<fo:table-cell border-right-style='solid' border-right-width='0.3pt' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' font-size='7pt' color='black'>%</fo:block>
                        </fo:table-cell>
        		<fo:table-cell border-right-style='solid' border-right-width='0.3pt' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' font-size='7pt' color='black'>Nº</fo:block>
                        </fo:table-cell> 
      ...
      <xsl:template match="columna">
          <fo:table-cell display-align="center" border-left-width='0.3pt' border-left-style='solid'>
               <fo:block line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='6pt' color='black'>
