...
<!--
    Document   : AtencionServicio.xsl
    Created on : 8 de marzo de 2007, 16:39
    Author     : t610908
    Description:
    ...
    <xsl:template match="datosTabla">
 	...
 	<fo:layout-master-set>
        ...
        <fo:page-sequence initial-page-number='1' master-reference='A4-landscape'>
            <fo:static-content flow-name='header'>
                ...
                <fo:table margin-right='2in div 12' table-layout='fixed' width='100%'>
					...
					Tiempos de Atencion de Servicio
        			</fo:block>
                            </fo:table-cell>
                            <fo:table-cell display-align="center">
                ...
                <fo:table-header background-color='#e6e6e6'>
                    <fo:table-row border-start-style='solid' border-end-style='solid' border-before-style='solid' border-width='0.3pt'>
                        ...
                        <fo:table-cell border-style='solid' border-width='1pt' number-columns-spanned='13' display-align="center">
                            <fo:block text-align='center' line-height='13pt' font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                Atendidas Entrantes Directas
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-style='solid' border-width='1pt' number-columns-spanned='13' display-align="center">
                            <fo:block text-align='center' line-height='13pt'  font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                Atendidas Entrantes Internas
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-style='solid' border-width='1pt' number-columns-spanned='3' display-align="center">
                            <fo:block text-align='center' line-height='13pt'  font-family='sans-serif' font-weight='bold' font-size='7pt' color='black'>
                                Consultas internas
                            </fo:block>
                        </fo:table-cell>
                    ...
                    <fo:table-row border-start-style='solid' border-end-style='solid' border-before-style='solid' border-width='0.3pt'>
                        <fo:table-cell border-style='solid' border-width='1pt' number-rows-spanned='2' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' font-size='6pt' color='black' text-decoration='underline' font-weight='bold'>
                                <xsl:value-of select="desglose"/>
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-style='solid' border-width='0.3pt' number-columns-spanned='3' display-align="center">
                            <fo:block text-align='center' line-height='9pt' padding-top='5pt' font-family='sans-serif'  vertical-align='middle' font-size='6pt' color='black'>
                                Total													 
                            </fo:block>
                        </fo:table-cell>        						
                        <fo:table-cell border-style='solid' border-width='0.3pt' number-columns-spanned='2' display-align="center">
                            <fo:block text-align='center' line-height='9pt' padding-top='5pt' vertical-align='middle' font-family='sans-serif' font-size='6pt' color='black'>
                                Timbre
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-style='solid' border-width='0.3pt' number-columns-spanned='2' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' font-size='6pt' color='black' padding-top='5pt' vertical-align='middle'>
                                Conversación
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell border-right-style='solid' border-width='0.3pt' number-columns-spanned='2' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' vertical-align='middle'	font-size='6pt' color='black'>
                                Retenida
                            </fo:block>									
                        </fo:table-cell>    
                        ...
                        <fo:table-cell border-right-style='solid' number-columns-spanned='2' border-width='0.3pt' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='6pt' color='black'>
                                Retenida
                            </fo:block>
                        </fo:table-cell>  
                        ...
                        <fo:table-cell border-right-style='solid' border-right-width='1pt' border-left-width='1pt' number-columns-spanned='3' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='6pt' color='black'>
                                Total
                            </fo:block>
                        </fo:table-cell>        						
                    ...
                    <fo:table-row border-start-style='solid' border-end-style='solid' border-before-style='solid' border-width='0.3pt'>
                        <fo:table-cell border-style='solid' border-width='0.3pt' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='6pt' color='black'>
                                Nº
                            </fo:block>
                        </fo:table-cell>
                        ...
                        <fo:table-cell border-style='solid' border-width='0.3pt' border-right-width='1pt' display-align="center">
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='6pt' color='black'>
                                %
                            </fo:block>
                        </fo:table-cell>
                        ...
                        <fo:table-cell border-style='solid' border-width='0.3pt' display-align="center" border-right-width='1pt'>
                            <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='6pt' color='black'>
                                %
                            </fo:block>
                        </fo:table-cell>                        
      ...
      <xsl:template match="columna">
          <fo:table-cell padding-left='1mm' border-left-width='0.3pt' border-left-style='solid'>
               <fo:block text-align='center' line-height='9pt' font-family='sans-serif' padding-top='5pt' font-size='5pt' color='black'>
