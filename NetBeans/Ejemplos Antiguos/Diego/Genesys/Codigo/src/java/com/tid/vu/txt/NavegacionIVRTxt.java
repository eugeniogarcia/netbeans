 ...
 * @author t610908
 */
public class NavegacionIVRTxt {
    
    private BufferedWriter escritor;        
    private ParametrosSeleccion parametros;
    
    /** Creates a new instance of NavegacionIVRTxt */
    public NavegacionIVRTxt(File fichero, ParametrosSeleccion parametros, Tabla consulta) throws IOException {
