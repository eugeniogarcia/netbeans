...
public class MiRequestor {
	...
	protected MiRequestor() {
		super();
	}
        
        
	public static MiRequestor newRequestor(Connection connection, String requestQueueName,
		String replyQueueName, String invalidQueueName)
		throws JMSException, NamingException {
			
		MiRequestor requestor = new MiRequestor();
