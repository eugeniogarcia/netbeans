 ...
 *         --
 */
//Una bean sin estado, local (se puede ejecutar directamente, sin hacer referencia al interfaz
//local y remota
@Stateless
@LocalBean
...
// OK     WorldEJB09 worldEJB = (WorldEJB09) ctx.lookup("java:global/chapter07-2.0/WorldEJB09!org.beginningee6.book.chapter07.ex09.WorldEJB09");
// OK        WorldEJB09 worldEJB = (WorldEJB09) ctx.lookup("java:global/chapter07-2.0/WorldEJB09");
// OK        WorldEJB09 worldEJB = (WorldEJB09) ctx.lookup("java:app/chapter07-2.0/WorldEJB09!org.beginningee6.book.chapter07.ex09.WorldEJB09");
// OK        WorldEJB09 worldEJB = (WorldEJB09) ctx.lookup("java:app/chapter07-2.0/WorldEJB09");
// OK        WorldEJB09 worldEJB = (WorldEJB09) ctx.lookup("java:module/WorldEJB09!org.beginningee6.book.chapter07.ex09.WorldEJB09");
