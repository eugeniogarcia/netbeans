 ...
 * generated in the org.beginningee6.book.chapter14 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Validate_QNAME = new QName("http://chapter14.book.beginningee6.org/", "validate");
    private final static QName _CreditCard_QNAME = new QName("http://chapter14.book.beginningee6.org/", "creditCard");
    private final static QName _ValidateResponse_QNAME = new QName("http://chapter14.book.beginningee6.org/", "validateResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.beginningee6.book.chapter14
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://chapter14.book.beginningee6.org/", name = "validate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://chapter14.book.beginningee6.org/", name = "creditCard")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://chapter14.book.beginningee6.org/", name = "validateResponse")
